	...
	public static WebDriver doBrowserSetup(String browser) throws MalformedURLException {
		...
		if (pro.getProperty("grid_run").equals("y")) {
			...
			if (browser.equalsIgnoreCase("chrome")) {
				...
				log.info("open grid chrome browser");
				...
				log.info("open grid firefox_win browser");
				...
				threadLocalDriver.set(new RemoteWebDriver(new URL(nodeurl), options));
				// driver = new RemoteWebDriver(new URL(nodeurl), options);
				log.info("open grid firefox_linux browser");
				...
				// options.merge(cap);
				// driver = new RemoteWebDriver(new URL(nodeurl), options);
				log.info("open grid edge browser");
			...
			if (browser.equals("chrome")) {
				...
				log.info("open local machine chrome browser");

			} else if (browser.equals("firefox_win")) {

				WebDriverManager.firefoxdriver().setup();
				threadLocalDriver.set(new FirefoxDriver());
				log.info("open local machine firefox_win browser");

			} else if (browser.equals("ie")) {

				WebDriverManager.iedriver().setup();
				threadLocalDriver.set(new InternetExplorerDriver());
				log.info("open local machine internetExplorer browser");

			} else if (browser.equals("edge")) {

				WebDriverManager.edgedriver().setup();
				threadLocalDriver.set(new EdgeDriver());
				log.info("open local machine edge browser");
			}
